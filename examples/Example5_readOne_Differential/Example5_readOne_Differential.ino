...
uint8_t sensorA = 1;         //must be 1,2,3,or 4
uint8_t sensorB = 2;         //must be 1,2,3,or 4 and NOT same as sensor A
...
void setup() {
  ...
  myFDC1004.setupDifferentialMeasurement(measurement, sensorA, sensorB);
